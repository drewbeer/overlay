...
SRC_URI="https://github.com/mariadb-corporation/MaxScale/archive/maxscale-${PV}.tar.gz"
KEYWORDS=""
...
S="${WORKDIR}/MaxScale-maxscale-2.0.2"

src_prepare() {
		epatch "${FILESDIR}"/cmakelist.patch-2.0.0
}
