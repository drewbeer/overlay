...
"
IUSE="${IUSE_VOICEMAIL_STORAGE} alsa bluetooth calendar +caps cluster curl dahdi debug doc freetds gtalk http iconv ilbc jabber ldap libedit lua meetme mysql newt +samples odbc osplookup oss portaudio postgres radius selinux snmp span speex srtp static syslog vorbis"
...
PATCHES=( "${WORKDIR}/asterisk-patchset"
           "${FILESDIR}/11.10.0/patches/asterisk-11.10.0-dtls.patch"
)
